...
from preprocessing.tokenizer import DummySentencizer, DummyTokenizer


def test_dummysentencizer():
    sentences = DummySentencizer(
        'All human beings are born free and equal in dignity and rights. They are endowed with reason and conscience and should act towards one another in a spirit of brotherhood.')
    assert sentences.sentences == ['All human beings are born free and equal in dignity and rights.',
    ...
    sentences = DummySentencizer(
        'This is a sentence: this is another sentence. A third sentence, oh my! Four? I dont believe it!', )
    assert sentences.sentences == ['This is a sentence:', 'this is another sentence.', 'A third sentence, oh my!',
                                   'Four?', 'I dont believe it!']
    sentences = DummySentencizer('')
...
def test_dummytokenizer():
    ...
    assert tokens.tokens == ['All', 'human', 'beings', 'are', 'born', 'free', 'and', 'equal', 'in', 'dignity', 'and',
                             'rights', '.']
